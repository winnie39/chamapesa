                        ...
                        <form class="profit-calculator">
                            ...
                            <div class="row mb-none-30">
                                    ...
                                    <template x-if="selectedPlanDetails">
                                        ...
                                        <input type="text" name="invest_amount" id="invest_amount" placeholder="0.00"
                                            ...
                                            'USD / ' + parseInt(selectedPlanDetails['price'] * rates['KES'] *
                                                1.07) + 'KES'"
                                            readonly class="form-control base--bg">
                                    </template>


                                    <template x-if="!selectedPlanDetails">

                                        <input type="text" name="profit_amount" :value="'0 USD / 0 KES'"
                                            id="profit_amount" placeholder="0.00" class="form-control base--bg" disabled>
                                    </template>
                                </div>
                                ...
                                <div class="col-lg-12 mb-30">
                                    ...
                                    <template x-if="selectedPlanDetails">
                                        <input type="text" name="profit_amount"
                                            :value="parseFloat(selectedPlanDetails['price'] *
                    ...
                    <ul class="nav nav-tabs custom--style-two justify-content-center" id="transactionTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="deposit-tab" data-toggle="tab" href="#deposit"
                                role="tab" aria-controls="deposit" aria-selected="true">Latest Deposit</a>
                        </li>
                        <li class="nav-item" role="presentation">
                                ...
                                <table class="table style--two">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td data-label="Name">
                                                <div class="user">
                                                    <div class="thumb"><img src="assets/images/investor/1.jpg"
                                                            alt="image"></div>
                                                    <span>fahaddevs</span>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td data-label="Name">
                                                <div class="user">
                                                    <div class="thumb"><img src="assets/images/investor/2.jpg"
                                                            alt="image"></div>
                                                    <span>Jon Tulsa</span>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td data-label="Name">
                                                <div class="user">
                                                    <div class="thumb"><img src="assets/images/investor/3.jpg"
                                                            alt="image"></div>
                                        ...
                                        <tr>
                                            <td data-label="Name">
                                                <div class="user">
                                                    <div class="thumb"><img src="assets/images/investor/6.jpg"
                                                            alt="image"></div>
                                                    <span>Thomas Okeyson</span>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td data-label="Name">
                                                <div class="user">
                                                    <div class="thumb"><img src="assets/images/investor/7.jpg"
                                                            alt="image"></div>
                                                    <span>Thomas Okeyson</span>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td data-label="Name">
                                                <div class="user">
                                                    <div class="thumb"><img src="assets/images/investor/8.jpg"
                                                            alt="image"></div>
                                                    <span>Thomas Okeyson</span>
                                                </div>
                                            </td>
