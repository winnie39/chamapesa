                            ...
                            <div class="d-widget d-flex flex-wrap">
                                <div class="col-8">
                                    ...
                                    <h4 class="currency-amount">{{ config('app.currency') }}
                                        {{ (float) auth()->user()->wallet->deposit }} </h4>
                                </div>
                                <div class="col-4">
                        ...
                        <div class="col-xl-4 col-sm-6 mb-30">
                            <div class="d-widget d-flex flex-wrap">
                                <div class="col-8">
                                    ...
                                    <h4 class="currency-amount">{{ config('app.currency') }}
                                        {{ (float) auth()->user()->wallet->profits }} </h4>
                                </div>
                                <div class="col-4">
                                    <div class="icon ml-auto">
                        ...
                        <div class="col-xl-4 col-sm-6 mb-30">
                            <div class="d-widget d-flex flex-wrap">
                                <div class="col-8">
                                    ...
                                    <h4 class="currency-amount">{{ config('app.currency') }}
                                        {{ (float) $data['totalInvestments'] }} </h4>
                                </div>
                                <div class="col-4">
                                    <div class="icon ml-auto">
                                ...
                                <div class=" w-full ">
                                    ...
                                    <div class="flex w-full gap-x-2 ">
                                        <input class=" form-control w-full" type="text"
                                            value="{{ auth()->user()->referral->link }}" id="myInput"
                                            readonly="readonly">
                                    ...
                                    <div class="flex flex-col gap-y-4">
                                        ...
                                        @foreach ($data['tasks'] as $task)
                                            <form action="/ranking/claim" method="POST">
                                                @csrf
                                                <div
                                                    class="  rounded-md  bg-black flex px-2 py-3 flex-col gap-y-2 text-white ">
                                                    <div
                                                        class="
